...
/**
 * afterResolution(token: AriesCore.InjectionToken<any>, callback: PostResolutionInterceptorCallback<any>, options?: InterceptorOptions): void
 ...
 */
export async function jsa_aries_agent_injectionContainer_afterResolution(agent_key, token, callback, userDataParameterName, userData) {
	// BEGIN USER CODE
	try{
		...
		await agent.injectionContainer.afterResolution(token,()=>{
