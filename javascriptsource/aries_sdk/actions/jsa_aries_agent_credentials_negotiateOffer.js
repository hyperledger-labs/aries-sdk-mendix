 ...
 */
export async function jsa_aries_agent_credentials_negotiateOffer(agent_key, options) {
	// BEGIN USER CODE
	try{
		...
		return Promise.resolve(JSON.stringify(await agent.credentials.negotiateOffer(options)));
	}catch(e){
