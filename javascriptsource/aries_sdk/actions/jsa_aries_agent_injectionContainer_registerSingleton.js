...
/**
 * registerSingleton(from: AriesCore.InjectionToken<any>, to: AriesCore.InjectionToken<any>): DependencyContainer
 * @param {string} agent_key
 * @param {string} from - json?
 * @param {string} to - json?
 * @returns {Promise.<string>}
 */
export async function jsa_aries_agent_injectionContainer_registerSingleton(agent_key, from, to) {
	// BEGIN USER CODE
	try{
		...
		return Promise.resolve(JSON.stringify(agent.injectionContainer.registerSingleton(from,to)));
	}catch(e){
