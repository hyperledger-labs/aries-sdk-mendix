...
/**
 * deactivate(options: AriesCore.DidDeactivateOptions): Promise<AriesCore.DidDeactivateResult>
 ...
 */
export async function jsa_aries_agent_dids_deactivate(agent_key, options) {
	// BEGIN USER CODE
	try{
		...
		return Promise.resolve(JSON.stringify(await agent.dids.deactivate(options)));
	}catch(e){
